...
func (s *fileStore) loadProducts() ([]domain.Product, error) {
...
func (s *fileStore) saveProducts(products []domain.Product) error {
...
func (s *fileStore) GetAll() ([]domain.Product, error) {
...
func (s *fileStore) GetOne(id int) (domain.Product, error) {
	products, err := s.loadProducts()
	if err != nil {
...
func (s *fileStore) AddOne(product domain.Product) error {
	products, err := s.loadProducts()
	if err != nil {
		return err
	}
...
func (s *fileStore) UpdateOne(product domain.Product) error {
	products, err := s.loadProducts()
	if err != nil {
		return err
	}
...
func (s *fileStore) DeleteOne(id int) error {
	products, err := s.loadProducts()
	if err != nil {
		return err
	}
